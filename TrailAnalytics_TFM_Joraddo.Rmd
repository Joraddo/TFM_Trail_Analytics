...
```{r Generete and export new dataset - Activities_final_Analysis}
...
## Modelo evolutivo GAM.

```{r Shiny APP - Generalized Additive Model , eval=FALSE, echo=TRUE}
...
```{r Shiny APP - Comments , eval=FALSE, echo=TRUE}
...
```{r , echo=FALSE}
url <- "https://9gi2dw-joraddo.shinyapps.io/TrailAnalytics_GAM/"

knitr::asis_output(
  sprintf('<a href="%s" target="_blank">App Shiny GAM</a>', url)
)
```
